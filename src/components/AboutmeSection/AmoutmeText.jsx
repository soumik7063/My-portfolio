...
const AmoutmeText = () => {
  return (
    <div className='flex flex-col md:items-start items-center md:text-left text-center'>
        ...
        <a href="#_" class=" mt-5 rounded-full relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-bold transition-all  bg-white hover:bg-white group">
